...
$allowed = array("https://www.verse.co.uk", "https://www.sck-webworks.co.uk", "http://long-ashes.test:8888", "http://long-ashes.lle.dev.verseapps.co.uk/", "http://www.longashespark.co.uk", "https://www.longashespark.co.uk");

//Needs to be user specific
$iuserid = '6309432576';
$itoken = '6309432576.dc53803.636a91a6ec834773b71e249a377574b7';
...
if($last>=time()-900){
	...
	if(isset($fbpageid)) {
		...
		$fburl = "https://graph.facebook.com/v2.10/".$puserid."/posts/";
